...
def submit_feedback(
    ...
    if file:
        ...
        # ✅ Physical file save path (Docker container path)
        physical_path = os.path.join(UPLOAD_DIR, file_id)

        with open(physical_path, "wb") as f:
            f.write(contents)

        # ✅ Public URL path (THIS is what we store in DB)
...
def delete_feedback(
    ...
    if file_path:
        try:
            ...
            physical_path = file_path.replace("/uploads", "/app/data/uploads")
